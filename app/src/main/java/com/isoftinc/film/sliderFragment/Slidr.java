package com.isoftinc.film.sliderFragment;
...
import com.isoftinc.film.sliderFragment.model.SlidrConfig;
import com.isoftinc.film.sliderFragment.model.SlidrInterface;
import com.isoftinc.film.sliderFragment.widget.SliderPanel;
...
public final class Slidr {
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@linkcom.sws.oneonone.sliderFragment.model.SlidrConfig}
     *
     * @param activity the activity to attach the slider to
